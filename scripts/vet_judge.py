...
NO only on positive evidence: the culture pictured by outsiders (European art, a named European artist, travel engravings); museums or galleries themselves; a map, diagram, flag, logo, screenshot, a scanned page of a document or book, specimen or placeholder; a modern politician or celebrity; a snapshot whose subject is something else; the ethnonym only an incidental word in the title; the record naming a different people ("Shan cloth" filed under Bamar); or the unmistakable style of a distant tradition (a Japanese print under Kongo, a pictorial Cambodian pidan silk under Uzbek).
