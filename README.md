...
- [`docs/world-peoples.md`](docs/world-peoples.md) — every people the British Museum holds 30+ image objects for, per continent, with category breadth (generated by `scripts/world_peoples.py`; the steps are in its docstring)
