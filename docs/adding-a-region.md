...
Measured 2026-09-25 on the 71 existing writeups: ~$0.05 per culture, all 71 rewritten. Before the retry carried the audit's objections, the audit caught real inventions that were never written: Qashqai *dastband*/*tisnak*/*ziyārat*, Kinh *đúc*, a Kongo "1.25 million" where the original says "ten and sixteen million", and a misspelt Kongo *minkski* for *minkisi*. Sonnet 5 costs ~$0.50 per culture for the same job because it ignores `MAX_THINKING_TOKENS=0`, so use Haiku.
